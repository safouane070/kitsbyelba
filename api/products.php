...
try {
    ...
    $rows = $pdo->query(
        "SELECT id, name, version, league, cat, emoji, price, badge, cat_cover, image, image2, image3, image_order, stock, stock_sizes, in_voorraad,
                kits_path,
                description, fit_info, size_advice, material_info, shipping_info, returns_info,
                personalization_policy, care_instructions
